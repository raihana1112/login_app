...
foreach ($peringkat as $rank => $index) {
    ...
    if ($alternatif[$index] == "Cabai") {
        ...
        $hasil_akhir[] = array($alternatif[$index], $hasil[$index], $bulan_panen, $panen, ($panen / 1000), number_format($hargapanen, 0, ',', '.'), number_format(intval($hargapanen * $panen), 0, ',', '.'));
...
echo json_encode($hasil_akhir) . '<br>';
