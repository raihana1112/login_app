...
$data_rekom =  array($jenis, $panen, $panen / 1000, $bulan_panen);
...
foreach ($lanjut as $i => $bulan) {
    ...
    $hasil_akhir[] = array($C1[$index], $C2[$index], $C3[$index], $C4[$index], number_format($C5[$indexC5]), number_format(intval($C5[$indexC5] * $panen)));
}
...
echo '//data prediksi => var = $hasil_akhir';
echo '<br>' . json_encode($hasil_akhir);
